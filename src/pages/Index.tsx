...
import { Calculator, Sparkles, BookOpen, Gamepad2, Trophy } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        <div className="max-w-2xl mx-auto text-center relative z-10">
          ...
          <div className="inline-flex items-center justify-center w-24 h-24 md:w-32 md:h-32 rounded-3xl gradient-primary mb-8 float elevated-shadow">
            <Calculator className="w-12 h-12 md:w-16 md:h-16 text-primary-foreground" />
          </div>
      ...
      <footer className="py-6 text-center text-muted-foreground text-sm">
        <p>Made with ❤️ for math learners everywhere</p>
      </footer>
    </div>
  );
}
